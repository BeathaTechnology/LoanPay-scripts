...
Set up collections
	...
	* First one in for creating order and in that you only need to put marchant_id and rest of data needed for valid request
		- If you are a gateway then under vendor_id put merchant id for which is order being created
	* In second one you need to put in merchant id and phone number
